...
var _recipeViwe = require("./views/recipeViwe");
var _recipeViweDefault = parcelHelpers.interopDefault(_recipeViwe);
...
const controlRecipes = async function() {
    try {
        ...
        if (!id) return;
        (0, _recipeViweDefault.default).renderSpiner();
        // update result view to mark 
        (0, _resultviewDefault.default).update(_model.getSearchResult());
        // update bookmark 
        (0, _bookMarksViewDefault.default).update(_model.state.bookmarks);
        // loading recipe 
        await _model.loadRecipe(id);
        // rendring recipe 
        (0, _recipeViweDefault.default).render(_model.state.recipe);
    } catch (error) {
        (0, _recipeViweDefault.default).renderError();
    }
};
const controlSearchResult = async function() {
    try {
        (0, _resultviewDefault.default).renderSpiner();
        // get search query 
        ...
        // render result
        (0, _resultviewDefault.default).render(_model.getSearchResult());
        // render pagintion 
...
const controlServing = function(newServing) {
    ...
    _model.updateServing(newServing);
    // updat the recipr view 
    // recipeView.render(model.state.recipe)
    (0, _recipeViweDefault.default).update(_model.state.recipe);
};
...
const init = function() {
    (0, _bookMarksViewDefault.default).addHandelerRender(controlBookmarks);
    (0, _recipeViweDefault.default).addHanderlRender(controlRecipes);
    (0, _recipeViweDefault.default).addhnadlerUpdateRecipe(controlServing);
    (0, _recipeViweDefault.default).addHanderlAddBookmark(controlAddBookmark);
    (0, _searchViewDefault.default).addHandelerSearh(controlSearchResult);
    (0, _addRecipeviewDefault.default).addHandlerUpload(controlAddRecipe);
    (0, _paginationViewDefault.default).addHandlerClick((page)=>{
        // render upadted result 
        (0, _resultviewDefault.default).render(_model.getSearchResult(page));
        // upadted render pagintion 
        (0, _paginationViewDefault.default).render(_model.state.search);
    });
};
init();

},{"core-js/modules/web.immediate.js":"bzsBv","./model":"3QBkH","./views/recipeViwe":"8tY2Y","./views/searchView":"kbE4Z","./views/resultview":"aqYl4","./views/paginationView":"7NIiB","./views/bookMarksView":"lsl50","./views/addRecipeview":"3y16N","./config":"2hPh4","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const loadRecipe = async function(id) {
    try {
        const data = await (0, _helper.requestJson)(`${(0, _config.API_URL)}${id}?key=${(0, _config.KEY)}`);
...
const loadSearchResult = async function(query) {
    try {
        ...
        const data = await (0, _helper.requestJson)(`${(0, _config.API_URL)}?search=${query}&key=${(0, _config.KEY)}`);
...
const getSearchResult = function(page = state.search.page) {
...
const upLoadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((e)=>e[0].startsWith('ingredient') && e[1] !== "").map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error("worng ingradint format ");
        ...
        const data = await (0, _helper.requestJson)(`${(0, _config.API_URL)}?key=${(0, _config.KEY)}`, recipe);
        state.recipe = createRecipeObj(data);
        addBookmark(state.recipe);
        console.log(createRecipeObj(data));
    } catch (err) {
        throw err;
    }
} //8dd489c0-b5f1-4587-992e-ee1675e7cf72
 //[{"id":"68c3d37e71bafb0015598147","title":"TESTasdf","publisher":"TEST","sourceUrl":"TESTasf","image":"TESTasd","servings":23,"cookingTime":23,"ingredients":[],"key":"8dd489c0-b5f1-4587-992e-ee1675e7cf72","bookmark":true}]
;

},{"regenerator-runtime":"f6ot0","./config":"2hPh4","./helper":"b1fwP","lodash":"lClA6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
parcelHelpers.export(exports, "timeOutScend", ()=>timeOutScend);
parcelHelpers.export(exports, "RES_PER_PAGE", ()=>RES_PER_PAGE);
parcelHelpers.export(exports, "KEY", ()=>KEY);
parcelHelpers.export(exports, "MODEL_CLOSE_SEC", ()=>MODEL_CLOSE_SEC);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes/";
const timeOutScend = 10;
const RES_PER_PAGE = 7;
const KEY = '9106875a-452b-45c0-9702-a3c9d725252c';
...
const requestJson = async function(url, uploadData) {
    try {
        ...
        const res = await Promise.race([
            ...
            timeout((0, _config.timeOutScend))
        ]);
...
},{"./config":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lClA6":[function(require,module,exports,__globalThis) {
/**
 * @license
...
},{}],"8tY2Y":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _message = "";
    addHanderlRender(fun) {
        const eve = [
            "load",
            "hashchange"
        ];
        eve.forEach((ev)=>window.addEventListener(ev, fun));
    }
    addhnadlerUpdateRecipe(handler) {
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
           ...
           <div class="recipe__user-generated ${this._data.key ? '' : 'hidden'}">
            <svg>
              <use href="./img/icons#icon-user"></use>
            </svg>
          </div>
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use href="./img/icons.svg#icon-bookmark${this._data.bookmark ? "-fill" : ""}"></use>
            </svg>
          </button>
        </div>
...
class View {
    _data;
    /**
        * render the recvied object 
        * @param {object | object[]} data  the data to be render 
        * @param {boolean } [render =true] if false , crear markup string instead of rendring dom ; 
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aqYl4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"fd0vu","./view":"2kjY2","lodash":"lClA6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7NIiB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"fd0vu","./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lsl50":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"fd0vu","./view":"2kjY2","./previewView":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3y16N":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"fd0vu","./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire06f7", {}, "./", "/")
